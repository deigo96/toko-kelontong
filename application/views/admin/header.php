  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4 overflow-hidden">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url ('assets/upload/user_profile/'.$profiles->gambar); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="<?php echo base_url('admin/adminProfile/').$profiles->id_login ?>" class="d-block"><?php echo $profiles->nama; ?></a>
        </div>
      </div>
