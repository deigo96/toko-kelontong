                ...
                <div class="col-md-6 offset-3 mt-3">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif ; ?>
                            <h3>Edit <?php echo $products[0]['pName']; ?></h3>
                            <?php echo form_open_multipart('admin/updateProduct', '', '') ?>
                                <div class="form-group">
                                    <?php echo form_input('productName',$products[0]['pName'], array('placeholder' => 'Masukan nama produk', 'class' => 'form-control')); ?>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <?php echo form_input('harga',$products[0]['harga'], array('placeholder' => 'Masukan harga', 'class' => 'form-control')); ?>
                                </div>
                                <div class="form-group">
                                    <?php echo form_input('stok',$products[0]['stok'], array('placeholder' => 'Masukan stok barang', 'class' => 'form-control')); ?>
                                </div>
                                <div class="form-group">
                                    <?php echo form_upload('prodDp', '','class="form-control custom-file"'); ?>
                                </div>
                                <div class="form-group">
                                    <?php echo form_submit('Ubah Product', 'Ubah Product', 'class="btn btn-primary offset-4"') ?>
                                </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
