...
|
*/
$config['base_url'] = 'http://localhost/amanah/';
...
$config['pageTitle'] = "AMANAH";
$config['pageTitleLogin'] = "AMANAH | Login";
$config['pageTitleAdmin'] = "AMANAH | Admin";
$config['pageTitleReg'] = "AMANAH | Register";